...
export default function Sidebar() {
  return (
    <div className="bg-[#1E3A8A] text-white w-64 space-y-6 pt-[100px] py-6 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
      <nav>
        {navItems.map((item) => (
